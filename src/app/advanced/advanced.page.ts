...
import { AnimationCountService } from '../services/animation-count.service'
import { KeyboardBinding, Keys } from '../services/keyboard.service'
 ...
 */
const PHOTO_FILTER = null //  = new PhotoPipe()
...
export class AdvancedPage {
	...
	photos: any[] = [
		{ section: SECTIONS.one, photos: sectionedPhotos[0] },
		{ section: SECTIONS.two, photos: sectionedPhotos[1] },
		{ section: SECTIONS.three, photos: sectionedPhotos[2] }
	]
	...
	ngOnInit() {
		this._keydownBinding = new KeyboardBinding(
